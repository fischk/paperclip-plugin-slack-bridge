...
export function parseInteractionActionValue(value?: string): InteractionActionValue {
  ...
  try {
    ...
    return {
      ...
      rejectRequiresReason: parsed.rejectRequiresReason === true,
      title: stringField(parsed.title),
      identifier: stringField(parsed.identifier),
      prompt: stringField(parsed.prompt),
      summary: stringField(parsed.summary),
      detailsMarkdown: stringField(parsed.detailsMarkdown),
      acceptLabel: stringField(parsed.acceptLabel),
      rejectLabel: stringField(parsed.rejectLabel),
